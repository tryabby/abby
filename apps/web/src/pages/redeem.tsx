  ...
  return (
    <main className='container px-6 py-6 md:px-16'>
      <div className='prose mt-12 max-w-full text-center lg:prose-lg prose-h1:font-bold prose-p:font-medium'>
        ...
        <p>
          Thank you very much for believing in Abby and buying a Lifetime License. In order to
        ...
        <p>
          Important: If you already have a subscription, make sure to cancel it first as it will be
          overridden.
        </p>
      </div>
    </main>
