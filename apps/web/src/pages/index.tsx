...
import { Clock, ExternalLink, FlaskConical, Shield, Blocks, Server, Code2 } from "lucide-react"
...
const { useAbby, AbbyProvider, useFeatureFlag, __abby__, withDevtools } = createAbby({
...
const Home: NextPageWithLayout<Omit<InferGetStaticPropsType<typeof getStaticProps>, "abbyData">> =
  ({ codeSnippet }) => {
    const { setTheme } = useTheme()
    const { onAct, variant } = useAbby("SignupButton")
    const { variant: heroMediaVariant, onAct: onHeroMediaAct } = useAbby("heroMedia")
    ...
    return (
      <>
        ...
        >
          <div className="flex flex-col items-center px-6 pb-12 pt-24 md:px-16">
            ...
            <h2 className="mx-auto mt-16 max-w-2xl text-center text-lg leading-relaxed">
              Abby is <b>Open Source</b> and <b>fully typed</b> with SDKs for <b>React</b> and{" "}
              <b>Next.js</b>. <br />
              Test in different environments, debug with devtools.
              <br /> Cut through feature deployment complexity with one service, built for
              developers.
            </h2>
            ...
            <div className="flex flex-col items-center">
              ...
              <span className="mt-4 text-xs">Start free, scale at a fair price.</span>
            </div>
        ...
        <section id="features" className="py-48">
          <div className="container px-6 md:px-16">
            ...
            <h2 className="mb-8 text-center text-lg">
              Born out of an engineer&apos;s frustration internally, and now adopted by engineering
              teams at fast-growing startups and enterprises.
            </h2>
            ...
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
              ...
              >
                SDKs for different frameworks, including React and Next.js. All of them fully
                type-safe.
              </Feature>
              <Feature icon={Server} title="Backend Coverage" subtitle="Optimized for server-side">
                Support for SSR or SSG included out of the box for a snappy user experience.
              </Feature>
              <Feature icon={FlaskConical} title="Environments" subtitle="Test safely">
                Utilize different environments for each feature flag or remote config variable.
                Create various environments to test features before they go live.
              </Feature>
              <Feature icon={Clock} title="Reliability First" subtitle="Reduce downtime risk">
                SDKs with built in fallbacks to reduce the risk of downtime and ensure a stable
                testing environment.
              </Feature>
              <Feature
                icon={Shield}
              ...
              >
                Fully open source, anonymized data, with the option to self-host (if you really
                wanted to).
              </Feature>
              <Feature icon={Code2} title="DevTools Included" subtitle="Contextual debugging">
                Install Abby&apos;s devtools to debug feature flags and remote config variables on
                the fly. First-Party CLI in Beta.
              </Feature>
            </div>
          </div>
        </section>
        ...
        <section className="py-48" id="devtools">
          <div className="container px-6 md:px-16">
            ...
            <h2 className="mb-12 text-center text-lg ">
              Debugging your feature flags & remote config variables has never been easier. Simply
        ...
        <section className="py-48">
          <div className="container px-6 md:px-16">
            ...
            <div className="flex items-center">
              ...
              >
                <span>Read the Docs</span> <ExternalLink className="-mt-1 h-5 w-5 stroke-2" />
              </Link>
            </div>
          </div>
        </section>
        ...
        <section id="pricing" className="py-48">
          <div className="container px-6 md:px-16">
            <h1 className="mb-6 text-center text-4xl font-bold">
              <span className="mark">Fair pricing</span> that scales with usage, not seats.
            </h1>
            <h2 className="mb-8 text-center text-lg">
              Start using feature flags and remote config variables for free. Scale up at reasonable
              pricing for small engineering teams and enterprises.
            </h2>
            <PricingTable />
          </div>
        </section>
        ...
        <section className="py-48">
          <div className="container relative px-6 md:px-16">
            <div className="relative mb-6 ">
              ...
              <h1 className="z-10 text-center text-4xl font-bold">Still have questions?</h1>
            </div>
            <h2 className="mb-8 text-center text-lg">
        ...
        <section className="py-48">
          <div className="container relative px-6 md:px-16">
            ...
            <h2 className="mb-8 text-center text-lg">
              If you&apos;re not yet familiar with website optimization and feature testing you can
              learn more about the terms and background of A/B tests (also known as Split tests)
              here.
            </h2>
            <div className="flex items-center">
              <Link
...
const HomeWrapper: NextPageWithLayout<InferGetStaticPropsType<typeof getStaticProps>> = ({
  codeSnippet,
  abbyData,
}) => (
