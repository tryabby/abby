...
const useOnboardingStore = create<{
  ...
  setExperienceLevelFlags: (experienceLevelFlags: number) => set({ experienceLevelFlags }),
  setExperienceLevelTests: (experienceLevelTests: number) => set({ experienceLevelTests }),
}))
...
const oneToFiveOptions = Array.from({ length: 5 }, (_, i) => i + 1).map((i) => ({
  label: i.toString(),
  value: i.toString(),
}))
