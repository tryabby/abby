    ...
    <main className='flex-1 py-12 md:py-24 lg:py-32'>
      <div className='container px-4 text-center md:px-6'>
        ...
        <p className='mx-auto mt-4 max-w-[700px] text-zinc-500 dark:text-zinc-400 md:text-xl'>
          We provide a wide range of integrations and SDKs to help you get the most out of our
          service.
        </p>
      </div>
...
IntegrationsMainPage.getLayout = (page) => {
  return <MarketingLayout seoTitle='Integations & SDKs | Abby'>{page}</MarketingLayout>
}
