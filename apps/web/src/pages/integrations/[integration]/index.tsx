...
const IntegrationPage: NextPageWithLayout<InferGetStaticPropsType<typeof getStaticProps>> = (
  props
) => {
  const integration = INTEGRATIONS.find((i) => i.docsUrlSlug === props.integrationSlug)
        ...
        <div className="container grid items-center justify-center gap-4 px-4 text-center md:px-6 lg:gap-10">
          <div className="space-y-3">
            ...
            <p className="mx-auto max-w-[700px] text-zinc-500 dark:text-zinc-400 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
              ...
              <span style={{ color: integration.logoFill }}>{integration.name}</span>
            </p>
          </div>
          <div className="mt-8 grid w-full grid-cols-1 gap-24 md:grid-cols-[1fr,auto]">
            ...
            <div className="flex flex-col space-y-4">
              ...
              <code className="rounded bg-gray-100 p-2 text-sm dark:bg-gray-800">
                npm install <span className="text-primary">@tryabby/{integration.npmPackage}</span>
              </code>
          ...
          <div className="mt-10">
            ...
            <p className="mx-auto max-w-[700px] text-zinc-500 dark:text-zinc-400 lg:text-base/relaxed ">
              Abby is an open-source Feature Flagging, Remote Config, and A/B Testing service.
              Abby&apos; {integration.name} SDK is fully typed and open source.
              <br />
              Abby is the easiest way to manage your features and experiments for Developers and
              Product Managers. Start now with our forever free plan.
            </p>
          </div>
          <SignupButton />
        </div>
