...
const { useAbby, AbbyProvider, useFeatureFlag, withDevtools, __abby__ } = createAbby({
      ...
      <section className='container relative px-6 font-mono lg:px-16'>
        <div className='flex flex-col items-center'>
          <div className='flex min-h-screen flex-col py-12 lg:py-24'>
            <h1 className='mb-8 text-center text-4xl font-extrabold lg:text-5xl'>
              <span className='mark'>Quit</span> the console.(&quot;Flag is &quot; + isOn)
            </h1>
            <div className='space-y-4 text-center text-lg font-medium lg:text-2xl'>
              <h2>Debugging is already hard, Debugging a Service is even harder 😮‍💨</h2>
              <h2 className='font-semibold'>Abby is here to help you with that</h2>
            </div>
            <video
            ...
            <span className='mt-12 text-center text-[10px] text-zinc-400 lg:text-xs'>
              Psst: If you&apos;re already too excited, just look at the bottom right{' '}
              {isExcited && (
                <>
                  <br />
                  <span className='bg-gradient-to-t from-purple-400 to-pink-500 bg-clip-text font-bold text-transparent'>
                    I knew it ! (you can see the other stuff at the bottom of the page. Scroll down)
                  </span>
                </>
              )}
            </span>
          ...
          <div className='relative h-full w-screen bg-zinc-800 py-24 text-center'>
            <div className='mb-24'>
              <h2 className='text-2xl font-bold lg:text-4xl'>Your Developers:</h2>
            ...
            <div className='grid grid-cols-1 items-center gap-y-12 lg:grid-cols-[1fr,auto,1fr]'>
              ...
              <div className='flex flex-col items-center space-y-3'>
                <h3 className='text-2xl font-bold text-pink-500'>After Abby Devtools</h3>
                <img
                  loading='lazy'
                  height={200}
                  width={340}
        ...
        <section className='my-12'>
          ...
          <h4 className='text-lg'>
            But let&apos; be honest, you just don&apos;t add something to your application, right?
            No worries
          </h4>
          <button
            type='button'
          ...
          <div className='flex flex-col items-center space-y-6'>
            {showHeading && <h1 className='h-7 text-xl'>You just toggled me!</h1>}
            {isExcited && (
        ...
        <div className='flex flex-col items-center'>
          <div className='relative h-full w-screen bg-zinc-800 py-24 text-center'>
            <h2 className='mb-6 text-2xl font-bold lg:text-4xl'>Ready to dive in?</h2>
            <p className='text-base lg:text-lg'>
              Sign up for Abby for free and start to enjoy a Feature Flag & A/B Testing solution
              that was made for developers
            </p>
...
const OuterPage: NextPageWithLayout<InferGetStaticPropsType<typeof getStaticProps>> = ({
  abbyData,
}) => {
  return (
...
OuterPage.getLayout = (page) => <MarketingLayout seoTitle='Devtools'>{page}</MarketingLayout>;
