...
const CodeRedemptionPage: NextPageWithLayout = () => {
  ...
  return (
    <div>
      <h2 className='text-2xl font-bold'>Redeem your Code for {project?.project.name}</h2>
      <form onSubmit={onSubmit} className='max-w-md space-y-3'>
        <label htmlFor='code' className='flex flex-col space-y-2'>
          ...
          />
          {formState.errors.code && <span className='text-red-500'>This field is required</span>}
        </label>
