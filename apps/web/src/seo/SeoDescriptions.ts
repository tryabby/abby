...
export function getMarketingSeo(pageName: string): SeoProps {
  ...
  switch (normalizedKey) {
    ...
    case '/login':
      return {
        metaTitle: 'Type-Safe Feature Flags and Flexible Remote Config| Abby Log in',
        metaDescription:
    ...
    case '/devtools':
      return {
        metaTitle: 'Learn about A/B testing tools and feature flags | Abby Documentation',
        metaDescription:
    ...
    case '/imprint':
      return {
        metaTitle: 'Type-Safe Feature Flags and Flexible Remote Config | Abby Legal Information',
        metaDescription:
    ...
    case '/tips-and-insights':
      return {
        metaTitle: 'Type-Safe Feature Flags and Flexible Remote Config| Abby Tips&Insights',
        metaDescription:
    ...
    case '/docs/integrations/svelte':
      return {
        metaTitle: 'Integrating A/B tests & Feature Flags with Svelte | Abby Documentation',
        metaDescription:
    ...
    case '/tips-and-insights/a-b-nextjs':
      return {
        metaTitle: 'A/B Testing in Next.js using Edge Middleware | Abby Tips & Insights',
        metaDescription:
    ...
    case '/tips-and-insights/abby-open-source':
      return {
        metaTitle: 'Open-Source A/B Test Transparency & Self-Hosted | Abby Tips&Insights',
        metaDescription:
    ...
    case '/tips-and-insights/feature-flags-next':
      return {
        metaTitle: 'Using Feature Flags in Next.js Applications | Abby Tips & Insights',
        metaDescription:
    ...
    case '/nextjs':
      return {
        metaTitle: 'A/B test for Next.js - Streamline A/B Tests & Feature Flags | Abby',
        metaDescription:
    ...
    case '/docs/feature-flags':
      return {
        metaTitle: 'Feature flag documentation for developers | Abby Documentation',
        metaDescription:
    ...
    case '/docs/reference/http':
      return {
        metaTitle: 'API Reference (HTTP API) for conducting A/B tests | Abby Documentation',
        metaDescription:
