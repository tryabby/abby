...
export default function Email({ inviteId, invitee, inviter, project }: Props) {
  const baseUrl = process.env.NODE_ENV === "development" ? "http://localhost:3000/" : ABBY_BASE_URL
      ...
      <Section style={main}>
        <Container style={container}>
          ...
          <Text style={text}>
            ...
            ) has invited you to the <strong>{project.name}</strong> team on <strong>Abby</strong>.
          </Text>
          <Section style={{ textAlign: "center" }}>
            <Button pX={20} pY={12} style={btn} href={`${baseUrl}invites/${inviteId}`}>
              Join the team
            </Button>
          </Section>
          <Text style={text}>
